...
#endif /* __cplusplus */
/* セル INIB 型宣言 #_CIP_# */
typedef const struct tag_nMruby_tInt8Pointer_INIB {
    /* call port #_NEP_# */ 
}  nMruby_tInt8Pointer_INIB;

/* CB は存在しない。INIB を CB の代わりに使用するための define #_DCI_# */
#define nMruby_tInt8Pointer_CB_tab           nMruby_tInt8Pointer_INIB_tab
#define nMruby_tInt8Pointer_SINGLE_CELL_CB   nMruby_tInt8Pointer_SINGLE_CELL_INIB
#define nMruby_tInt8Pointer_CB               nMruby_tInt8Pointer_INIB
#define tag_nMruby_tInt8Pointer_CB           tag_nMruby_tInt8Pointer_INIB

/* シングルトンセル CB プロトタイプ宣言 #_SCP_# */
extern  nMruby_tInt8Pointer_INIB  nMruby_tInt8Pointer_SINGLE_CELL_INIB;


/* セルタイプのIDX型 #_CTIX_# */
typedef const struct tag_nMruby_tInt8Pointer_INIB *nMruby_tInt8Pointer_IDX;
