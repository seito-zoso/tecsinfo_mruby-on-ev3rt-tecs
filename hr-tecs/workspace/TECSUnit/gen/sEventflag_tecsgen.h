...
struct tag_sEventflag_VMT {
    ...
    ER             (*wait__T)( const struct tag_sEventflag_VDES *edp, FLGPTN waitPattern, MODE waitFlagMode, FLGPTN* p_flagPattern );
    ER             (*waitPolling__T)( const struct tag_sEventflag_VDES *edp, FLGPTN waitPattern, MODE waitFlagMode, FLGPTN* p_flagPattern );
    ER             (*waitTimeout__T)( const struct tag_sEventflag_VDES *edp, FLGPTN waitPattern, MODE waitFlagMode, FLGPTN* p_flagPattern, TMO timeout );
