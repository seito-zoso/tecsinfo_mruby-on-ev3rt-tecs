...
#define nTECSInfo_tDefinedTypeInfo_SINGLE_CELL_CB   nTECSInfo_tDefinedTypeInfo_SINGLE_CELL_INIB
...
void         nTECSInfo_tDefinedTypeInfo_eTypeInfo_getNameLength(nTECSInfo_tDefinedTypeInfo_IDX idx, uint16_t* len);
void         nTECSInfo_tDefinedTypeInfo_eTypeInfo_getSize(nTECSInfo_tDefinedTypeInfo_IDX idx, uint32_t* size);
void         nTECSInfo_tDefinedTypeInfo_eTypeInfo_getKind(nTECSInfo_tDefinedTypeInfo_IDX idx, int8_t* kind);
void         nTECSInfo_tDefinedTypeInfo_eTypeInfo_getNType(nTECSInfo_tDefinedTypeInfo_IDX idx, int32_t* num);
void         nTECSInfo_tDefinedTypeInfo_eTypeInfo_getTypeInfo(nTECSInfo_tDefinedTypeInfo_IDX idx, int32_t ith, Descriptor( nTECSInfo_sTypeInfo )* desc);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
#define nTECSInfo_tDefinedTypeInfo_ATTR_bitSize( p_that )	((p_that)->bitSize)
...
#define nTECSInfo_tDefinedTypeInfo_GET_bitSize(p_that)	((p_that)->bitSize)
...
#define nTECSInfo_tDefinedTypeInfo_cTypeInfo_getNameLength( p_that, len ) \
	  (p_that)->cTypeInfo->VMT->getNameLength__T( \
	   (p_that)->cTypeInfo, (len) )
#define nTECSInfo_tDefinedTypeInfo_cTypeInfo_getSize( p_that, size ) \
	  (p_that)->cTypeInfo->VMT->getSize__T( \
	   (p_that)->cTypeInfo, (size) )
#define nTECSInfo_tDefinedTypeInfo_cTypeInfo_getKind( p_that, kind ) \
	  (p_that)->cTypeInfo->VMT->getKind__T( \
	   (p_that)->cTypeInfo, (kind) )
#define nTECSInfo_tDefinedTypeInfo_cTypeInfo_getNType( p_that, num ) \
	  (p_that)->cTypeInfo->VMT->getNType__T( \
	   (p_that)->cTypeInfo, (num) )
#define nTECSInfo_tDefinedTypeInfo_cTypeInfo_getTypeInfo( p_that, ith, desc ) \
...
#define ATTR_bitSize         nTECSInfo_tDefinedTypeInfo_ATTR_bitSize( p_cellcb )
...
#define cTypeInfo_getNameLength( len ) \
          nTECSInfo_tDefinedTypeInfo_cTypeInfo_getNameLength( p_cellcb, len )
#define cTypeInfo_getSize( size ) \
          nTECSInfo_tDefinedTypeInfo_cTypeInfo_getSize( p_cellcb, size )
#define cTypeInfo_getKind( kind ) \
          nTECSInfo_tDefinedTypeInfo_cTypeInfo_getKind( p_cellcb, kind )
#define cTypeInfo_getNType( num ) \
          nTECSInfo_tDefinedTypeInfo_cTypeInfo_getNType( p_cellcb, num )
#define cTypeInfo_getTypeInfo( ith, desc ) \
          nTECSInfo_tDefinedTypeInfo_cTypeInfo_getTypeInfo( p_cellcb, ith, desc )
