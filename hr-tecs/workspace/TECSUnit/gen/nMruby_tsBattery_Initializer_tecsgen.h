...
#endif /* __cplusplus */
/* セル INIB 型宣言 #_CIP_# */
typedef const struct tag_nMruby_tsBattery_Initializer_INIB {
    /* call port #_NEP_# */ 
}  nMruby_tsBattery_Initializer_INIB;

/* CB は存在しない。INIB を CB の代わりに使用するための define #_DCI_# */
#define nMruby_tsBattery_Initializer_CB_tab           nMruby_tsBattery_Initializer_INIB_tab
#define nMruby_tsBattery_Initializer_SINGLE_CELL_CB   nMruby_tsBattery_Initializer_SINGLE_CELL_INIB
#define nMruby_tsBattery_Initializer_CB               nMruby_tsBattery_Initializer_INIB
#define tag_nMruby_tsBattery_Initializer_CB           tag_nMruby_tsBattery_Initializer_INIB

extern nMruby_tsBattery_Initializer_CB  nMruby_tsBattery_Initializer_CB_tab[];

/* セルタイプのIDX型 #_CTIX_# */
typedef const struct tag_nMruby_tsBattery_Initializer_INIB *nMruby_tsBattery_Initializer_IDX;
...
/* セルCBを得るマクロ #_GCB_# */
#define nMruby_tsBattery_Initializer_GET_CELLCB(idx) (idx)
...
#define FOREACH_CELL(i,p_cb)   \
    for( (i) = 0; (i) < nMruby_tsBattery_Initializer_N_CELL; (i)++ ){ \
       (p_cb) = &nMruby_tsBattery_Initializer_CB_tab[i];
