...
/* 属性・変数の配列 #_AVAI_# */
/* セル INIB #_INIB_# */
nMruby_tsMotor_Initializer_INIB nMruby_tsMotor_Initializer_INIB_tab[] = {
    /* cell: nMruby_tsMotor_Initializer_CB_tab[0]:  VM_tsMotor_Initializer id=1 */
    {
        /* entry port #_EP_# */ 
    },
};
...
const struct tag_nMruby_tsMotor_Initializer_eInitialize_DES VM_tsMotor_Initializer_eInitialize_des = {
    ...
    &nMruby_tsMotor_Initializer_INIB_tab[0],   /* INIB */
};
/* CB 初期化コード #_CIC_# */
void
