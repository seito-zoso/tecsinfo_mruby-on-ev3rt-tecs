...
p "======  111111 ======"
p "creating bridge"
# sigBridge = TECS::TsSig.new( "SigBridge" )  # MrubyBridge Version
sigBridge = TECS::Bridge.join "Sig.eEnt"        # MrubyInfoBridge Version
# sigBridge2 = TECS::TsSig.new( "SigBridge2" )
sigBridge2 = TECS::Bridge.join "Sig2.eEnt"        # MrubyInfoBridge Version
