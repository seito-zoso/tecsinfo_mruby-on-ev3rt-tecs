...
struct tag_sEventflag_VMT {
    ER             (*set__T)( const struct tag_sEventflag_VDES *edp, FLGPTN set_pattern );
    ER             (*clear__T)( const struct tag_sEventflag_VDES *edp, FLGPTN clear_pattern );
    ER             (*wait__T)( const struct tag_sEventflag_VDES *edp, FLGPTN wait_pattern, MODE wait_flag_mode, FLGPTN* p_flag_pattern );
    ER             (*waitPolling__T)( const struct tag_sEventflag_VDES *edp, FLGPTN wait_pattern, MODE wait_flag_mode, FLGPTN* p_flag_pattern );
    ER             (*waitTimeout__T)( const struct tag_sEventflag_VDES *edp, FLGPTN wait_pattern, MODE wait_flag_mode, FLGPTN* p_flag_pattern, TMO timeout );
    ER             (*initialize__T)( const struct tag_sEventflag_VDES *edp );
    ER             (*refer__T)( const struct tag_sEventflag_VDES *edp, T_RFLG* pk_eventflag_status );
};
